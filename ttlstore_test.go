...
// TODO: tests for ttl cache
func TestTTLStore_Get(t *testing.T) {
	store := NewTTLStore(
		[][]byte{[]byte("authkey"),
...
func TestTTLStore_Get_Bogus(t *testing.T) {
	store := NewTTLStore(
		[][]byte{[]byte("authkey"),
		[]byte("enckey1234567890")},
	)
...
func TestTTLStore_New(t *testing.T) {
	store := NewTTLStore(
		[][]byte{[]byte("authkey"),
		[]byte("enckey1234567890")},
	)
...
func TestTTLStore_Save(t *testing.T) {
	store := NewTTLStore(
		[][]byte{[]byte("authkey"),
		[]byte("enckey1234567890")},
	)
...
func TestTTLStore_Save_Multiple_Requests(t *testing.T) {
	store := NewTTLStore(
		[][]byte{[]byte("authkey"),
		[]byte("enckey1234567890")},
	)
